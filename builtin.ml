...
let builtin_print v = Printf.printf "%s" (Value.get_s v) ; Value.Unit ;;
let builtin_println v = Printf.printf "%s\n" (Value.get_s v) ; Value.Unit ;;
...
let builtin_table =
  ...
  ; ("print", Type.Fun (Type.String, Type.Unit), Value.Builtin builtin_print)
  ; ("println", Type.Fun (Type.String, Type.Unit), Value.Builtin builtin_println) ]
;;
